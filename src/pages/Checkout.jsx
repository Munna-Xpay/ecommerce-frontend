    ...
    return (
      <Box>
        <Stack mt={3} direction={"row"}>
          ...
          <Box>
            <Typography mt={2}>{item.product.title}</Typography>
            <Typography fontWeight={"bold"}>${item.product.discounted_price}</Typography>
          </Box>
        </Stack>
            ...
            <Stack padding={2}>
              ...
              >
                ...
                <Typography fontSize={15} fontWeight={"bold"}>
                  ₹ {product.map((item) => item.product.original_price).length > 0 && product.map((item) => item.product.original_price * qtd)?.reduce((a, b) => a + b)}
              ...
              >
                ...
                <Typography fontSize={15} fontWeight={"bold"}>
                  - ₹ {product.map((item) => item.original_price).length > 0 && product.map((item) => item.product.original_price * qtd)?.reduce((a, b) => a + b) - product.map((item) => item.original_price)?.reduce((a, b) => a + b)}
                </Typography>
              </Box>
              <Box
                mt={2}
              ...
              >
                ...
                <Typography fontSize={15} fontWeight={"bold"}>
                  {product.map((item) => item.product.tax).length > 0 && product.map((item) => item.product.tax)?.reduce((a, b) => a + b)}%
