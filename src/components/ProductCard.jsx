    ...
    return (
        <Stack spacing={isCardLike ? 1 : 3} direction={isCardLike ? 'column' : 'row'} sx={{ width: '100%', position: 'relative' }}>
            ...
            <Box sx={{ position: 'absolute', top: '0', bottom: '0', left: '0', right: '0', opacity: { xs: '10', md: '0' }, '&:hover': { opacity: '10', transition: '.3s' } }}>
                <IconButton sx={{ position: 'absolute', top: isCardLike ? '130px' : '130px', left: isCardLike ? '10px' : '110px', backgroundColor: 'rgb(250, 84, 28)', color: '#efefef', boxShadow: 'rgba(250, 84, 28, 0.24) 0px 8px 16px 0px', '&:hover': { backgroundColor: 'rgb(150, 10, 28)', color: '#efefef' } }}>
                    <AddShoppingCartIcon />
                </IconButton>
            </Box>
